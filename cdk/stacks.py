...
class S3ObjectLambdaStack(Stack):
    def __init__(self, app: App, id: str) -> None:
        ...
        self.access_point = (
            f"arn:aws:s3:{Aws.REGION}:{Aws.ACCOUNT_ID}:accesspoint/"
        ...
        object_lambda_ap = s3_object_lambda.CfnAccessPoint(
            ...
            object_lambda_configuration=s3_object_lambda.CfnAccessPoint.ObjectLambdaConfigurationProperty(
        ...
        CfnOutput(
            self, "objectLambdaAccessPointArn", value=object_lambda_ap.attr_arn
        )
        CfnOutput(
            self,
